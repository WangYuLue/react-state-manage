...
const CityMessage = memo((props: { city: ICity }) => {
  ...
  const toggleSubscribeCity = useStore(state => state.toggleSubscribeCity);
  const updateCityWeather = useStore(state => state.updateCityWeather);
  const updateCityTemperature = useStore(state => state.updateCityTemperature);
